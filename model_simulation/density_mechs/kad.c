...
#define gmn gmn_kad
 double gmn = 0.39;
#define lscale lscale_kad
 double lscale = 1;
#define lmin lmin_kad
 double lmin = 2;
#define nmin nmin_kad
 double nmin = 0.1;
#define nscale nscale_kad
 double nscale = 1;
#define pw pw_kad
 double pw = -1;
#define qtl qtl_kad
...
#define zetan zetan_kad
 ...
 "qq_kad", &qq_kad,
 "nmin_kad", &nmin_kad,
 "nscale_kad", &nscale_kad,
 "a0l_kad", &a0l_kad,
 "zetal_kad", &zetal_kad,
 "lmin_kad", &lmin_kad,
 "lscale_kad", &lscale_kad,
 "q10_kad", &q10_kad,
 "qtl_kad", &qtl_kad,
 "gml_kad", &gml_kad,
 0,0
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kad C:/Users/Bence/Desktop/koki-ca1-simulation/density_mechs/kad.mod\n");
...
double betl ( _threadargsprotocomma_ double _lv ) {
   double _lbetl;
 _lbetl = exp ( zetal * gml * ( _lv - vhalfl ) * 1.e-3 * 9.648e4 / ( 8.315 * ( 273.16 + celsius ) ) ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "kad.mod";
static const char* nmodl_file_text = 
