...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 car C:/Users/Bence/Desktop/koki-ca1-simulation/density_mechs/car_new.mod\n");
...
static int  rates ( _threadargsproto_ ) {
    minf = 1.0 / ( 1.0 + exp ( ( v + 24.0 ) / ( - 15.0 ) ) ) ;
   mtau = ( 2.0 * v ) / v ;
   hinf = 1.0 / ( 1.0 + exp ( ( v + 32.0 ) / ( 10.0 ) ) ) ;
   htau = ( 100.0 * v ) / v ;
     return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "car_new.mod";
static const char* nmodl_file_text = 
