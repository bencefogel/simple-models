...
#define hmin hmin_nax
 double hmin = 0.5;
#define hscale hscale_nax
 double hscale = 1;
#define mmin mmin_nax
 double mmin = 0.02;
#define mscale mscale_nax
 double mscale = 1;
#define q10 q10_nax
 double q10 = 2;
#define qg qg_nax
...
#define thinf thinf_nax
 ...
 "thinf_nax", &thinf_nax,
 "qinf_nax", &qinf_nax,
 "mscale_nax", &mscale_nax,
 "hscale_nax", &hscale_nax,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 nax C:/Users/Bence/Desktop/koki-ca1-simulation/density_mechs/nax.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "nax.mod";
static const char* nmodl_file_text = 
  "TITLE na3\n"
